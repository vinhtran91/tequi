...
rm -f src/config/tequichain-config.h
...
rm -rf test_bitcoin.coverage/ tequichain-gtest.coverage/ total.coverage/
...
clean_exe src/tequichain-cli
clean_exe src/tequichaind
clean_exe src/tequichain-gtest
clean_exe src/tequichain-tx
clean_exe src/test/test_tequichain
clean_exe src/test/test_tequichain_fuzzy
...
clean_dep . src/config/tequichain-config.h.in
