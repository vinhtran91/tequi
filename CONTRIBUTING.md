# Contributing to Tequichain Core

The Tequichain Core project operates an open contributor model where anyone is
...
-   _Qt_ for changes to tequichain-qt
...
[Translation Process](https://github.com/Tequichain-Network/TequichainCore/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Tequichain Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Tequichain
Network Protocol consensus changes.

Whether a pull request is merged into Tequichain Core rests with the project merge
...
Patches that change Tequichain consensus rules are considerably more involved than
...
Where a patch set proposes to change the Tequichain consensus, it must have been
...
The review process is normally fairly responsive on the Tequichain Core repository, however
...
The project leader is the release manager for each Tequichain Core release.
