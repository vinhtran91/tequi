...
//! Interface for the src/evo part of a tequichain node (tequichaind process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a tequichain node (tequichaind process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a tequichain node (tequichaind process).
namespace Smartnode {
class Sync
{
public:
...
//! Top-level interface for a tequichain node (tequichaind process).
class Node
{
public:
    virtual ~Node() {}
