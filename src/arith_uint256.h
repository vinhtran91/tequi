...
#ifndef TEQUICHAIN_ARITH_UINT256_H
#define TEQUICHAIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Tequichain only uses this "compact" format for encoding difficulty
...
#endif // TEQUICHAIN_ARITH_UINT256_H
