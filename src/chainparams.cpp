...
{
    const char* pszTimestamp = "The Times 22/Mar/2024 Tequichain has gone online";
    const CScript genesisOutputScript = CScript() << ParseHex("04f3aff326447db375178d01ec3d151a326bf194f9ed033b027aec19089aa1e0fe23fc7f74ab314bf9d78cea4b4ed25c81f3e4b973789912a93d371b64c6658a50") << OP_CHECKSIG;
...
public:
    CMainParams()
    {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60;                                                       // Tequichain: 1 day
        consensus.nPowTargetSpacing = 2 * 60;                                                              // Tequichain: 2 minutes
        ...
        pchMessageStart[2] = 0x71; // q
        pchMessageStart[3] = 0x2e; //.
        nDefaultPort = 22152;
        nPruneAfterHeight = 100000;

        genesis = CreateGenesisBlock(1711390455, 2012, 0x20001fff, 4, 5000 * COIN);
        VerifyGenesisPOW(genesis);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xfc59fefa21015f872619272dc42355b3f837d408d61859091ff0fa37b4e800cd"));
        assert(genesis.hashMerkleRoot == uint256S("0x56554fbed01d075e268bcb3efa3eed7db9cdd563039f086032ee8e1f755adca4"));

        // vSeeds.emplace_back("mtn.tequichain.com");
        vSeeds.emplace_back("109.236.81.133");

        // Tequichain addresses start with 'T'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 65);
        // Tequichain script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 16);
        // Tequichain private keys start with '7' or 'X'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 128);
        // Tequichain BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // Tequichain BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};
        // Tequichain BIP44 coin type is '5'
        ...
        vSporkAddresses = {"TBtmGLQUQHzT7o8usq2G9Q8tdZbV8zrfSZ"};
        nMinSporkKeys = 1;
        fBIP9CheckSmartnodesUpgraded = true;

        checkpointData = {
            {{2012, uint256S("0xfc59fefa21015f872619272dc42355b3f837d408d61859091ff0fa37b4e800cd")}}};

        chainTxData = ChainTxData{
            1711390455, // * UNIX timestamp of last known number of transactions (Block 0)
...
public:
    CTestNetParams()
    {
        ...
        consensus.powLimit = uint256S("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20
        consensus.nPowTargetTimespan = 24 * 60 * 60;                                                       // Tequichain: 1 day
        consensus.nPowTargetSpacing = 60;                                                                  // Tequichain: 1 minutes
        ...
        // Testnet Tequichain addresses start with 't'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 127);
        // Testnet Tequichain script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);
        // Testnet Tequichain BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet Tequichain BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet Tequichain BIP44 coin type is '1' (All coin's testnet default)
        std::string strExtCoinType = gArgs.GetArg("-extcoinindex", "");
        ...
        chainTxData = ChainTxData{
            1711390455, // * UNIX timestamp of last known number of transactions (Block 213054)
            0,          // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
...
public:
    CDevNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        // vSeeds.push_back(CDNSSeedData("tequichain.org",  "devnet-seed.tequichain.org"));

        // Testnet Tequichain addresses start with 'e'
...
public:
    CRegTestParams()
    {
        ...
        // Regtest Tequichain addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 140);
        // Regtest Tequichain script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);
        // Regtest Tequichain BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Tequichain BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Tequichain BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
