...
#error Client version information missing: version is not defined by tequichain-config.h or in any other way
#endif
...
/**
 * tequichaind-res.rc includes this file, but it cannot cope with real c++ code.
