...
void smartnode_list_help()
{
    throw std::runtime_error(
        ...
        "  owneraddress   - Print the smartnode owner Tequichain address\n"
        "  payee          - Print the smartnode payout Tequichain address (can be additionally filtered,\n"
        "                   partial match)\n"
        "  pubKeyOperator - Print the smartnode operator public key\n"
        "  status         - Print smartnode status: ENABLED / POSE_BANNED\n"
        "                   (can be additionally filtered, partial match)\n"
        "  votingaddress  - Print the smartnode voting Tequichain address\n");
}
...
static const CRPCCommand commands[] =
    {
        ...
        //  --------------------- ------------------------  -----------------------  ----------
        {"tequichain", "smartnode", &smartnode, {}},
        {"tequichain", "smartnodelist", &smartnodelist, {}},
};
