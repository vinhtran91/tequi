    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about) {
        ...
        QString header = "Usage:\n"
                         "  tequichain-qt [command-line options]                     \n";
...
All the Tequichain in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 TEQ, 0.01 TEQ, 0.1 TEQ, 1 TEQ and 10 TEQ -- sort of like the paper money you use every day.</li> \
