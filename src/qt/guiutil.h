...
/** Utility functions used by the Tequichain Qt UI.
 */
namespace GUIUtil {
...
// Parse "tequichain:" URI into recipient object, return true on successful parsing
...
/** Load tequichain specific appliciation fonts */
bool loadFonts();
...
/** Check if a tequichain specific theme is activated (light/dark).*/
