...
/* TequichainGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* TequichainGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
...
#define QAPP_ORG_NAME "Tequichain"
#define QAPP_ORG_DOMAIN "tequichain.com"
#define QAPP_APP_NAME_DEFAULT "Tequichain-Qt"
#define QAPP_APP_NAME_TESTNET "Tequichain-Qt-testnet"
#define QAPP_APP_NAME_DEVNET "Tequichain-Qt-%s"
#define QAPP_APP_NAME_REGTEST "Tequichain-Qt-regtest"
