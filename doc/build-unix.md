...
Some notes on how to build Tequichain Core in Unix.

(for OpenBSD specific instructions, see [build-openbsd.md](build-openbsd.md))

## Base build dependencies

Building the dependencies and Tequichain Core requires some essential build tools and libraries to be installed before.
...
To help make your Tequichain installation more secure by making certain attacks impossible to
...
-   Non-executable Stack
    ...
    vulnerable buffers are found. By default, Tequichain Core should be built with a non-executable stack
...
When the intention is to run only a P2P node without a wallet, Tequichain Core may be compiled in
