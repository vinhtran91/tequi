...
"""Verify that starting tequichaind with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start tequichaind with -h for help text")
        ...
        self.log.info("Start tequichaind with -version for version information")
