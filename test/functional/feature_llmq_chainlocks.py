...
from test_framework.test_framework import TequichainTestFramework
...
class LLMQChainLocksTest(TequichainTestFramework):
    def set_test_params(self):
        self.set_tequichain_test_params(6, 5, fast_dip3_enforcement=True)
